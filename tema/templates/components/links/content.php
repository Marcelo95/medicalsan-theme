        ...
        <div class="list-links">
            <div>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#duvidas_frequentes" data-bs-toggle="modal"><i class="fa fa-question-circle	"></i> Dúvidas
                        frequentes</a>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#ficha_tecnica" data-bs-toggle="modal"><i class="fa fa-file-text-o"></i> Ficha Técnica</a>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#manual_de_instrucoes" data-bs-toggle="modal"><i class="fa fa-book	"></i> Manual de instruções</a>
            ...
            <div>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#assistencia_express" data-bs-toggle="modal"><i class="material-icons">contact_phone</i> Assistência
                        express</a>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#guia_rapido" data-bs-toggle="modal"><i class="material-icons">library_books</i> Guia
                        Rápido</a>
                ...
                ?>
                    ...
                    <a href="" data-bs-target="#videos_de_treinamento" data-bs-toggle="modal"><i class="fa fa-file-video-o"></i>Vídeos de
                        treinamento</a>
